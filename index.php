                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select id="filter_type" name="filter_type" class="custom-select">
                                        <option value=""></option>
                                        <?php
                                        foreach ($ma_status_specialoffers as $msaItem){
                                            ?>
...
$isCanAdd = true;
$isCanRemove = true;
$cardTitle = 'Promotions List';
$urlAddPage = 'specialoffers/add-specialoffers/';
                    ...
                    <tr>
                        ...
                        <td class="td_button_action">
                            <a role="button" class="btn btn-outline-warning btn-sm"
                               href="specialoffers/edit-specialoffers-<?php echo $item['id'] ?>/"
