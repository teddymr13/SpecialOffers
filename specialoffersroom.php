...
$isCanAdd = true;
$isCanRemove = true;
$cardTitle = 'room List - ' . $specialoffers_id;
$urlAddPage = 'specialoffers/add-specialoffersroom?specialoffersid='.$specialoffers_id;
    ...
    if ($count_row > 0) {
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <th scope="col"><?php ViewHelper::thLink($main_url, $hlm, $orderby, $order, 2, 'Judul',$filter_param); ?></th>
                <th scope="col"></th>
            </tr>
            </thead>
            <tbody>
            ...
            foreach ($data_list as $item) {
                ...
                <tr>
                    ...
                    <td><?php echo $item['judul_room']; ?></td>
                    <td class="td_button_action">
                        <a role="button" class="btn btn-outline-warning btn-sm"
                           href="specialoffers/edit-specialoffersroom-<?php echo $item['id'] ?>?specialoffersid=<?php echo $specialoffers_id; ?>"
